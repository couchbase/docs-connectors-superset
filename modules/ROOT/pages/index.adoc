...
The Couchbase SQLAlchemy Connector integrates Capella Columnar instances with the open-source data exploration and visualization platform Apache Superset by leveraging the Couchbase tabular analytics views capability.
--
...
*Username*:: Enter user with Analytics permissions (e.g., Cluster Admin).
